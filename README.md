...
1. **统一存储**：Mini Shell 的用户管理完全独立于 Linux 系统，所有用户信息存储在用户家目录下的 `.mini_users` 文件中（格式：用户名\t密码\t是否为root）。这种方式也被称为“平铺文件存储”。
...
最新测试报告：
- [版本 1.0 测试报告](tests/项目测试文档/测试报告/版本1.0_测试报告.md)
- [测试报告详细总结](tests/项目测试文档/测试报告/测试报告详细总结.md)
